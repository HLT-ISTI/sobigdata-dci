...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 10:
        set_status(100,
                   ...
                   'dcf=[cosine|pmi|linear] npivots phi '
    ...
    dci_dcf = sys.argv[3]  # 'cosine','pmi','linear'
    dci_pivots = int(sys.argv[4])
    dci_phi = int(sys.argv[5])
    dci_standardization = 'normal' if sys.argv[6] == 'TRUE' else None
    dci_optimize = True if sys.argv[7] == 'TRUE' else False
    dci_unify = True if sys.argv[8] == 'TRUE' else False
    dci_cross_consistency = True if sys.argv[9] == 'TRUE' else False
